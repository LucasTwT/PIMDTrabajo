...
def main() -> None:
    ...
    train_img_folder = ImageFolder(
						r'Scripts\Rama1\EjericiosPrácticos\5.TodoJunto\CNN\PIMDPrueba2\Data\Razas',
                            transforms=transform)
    #dataloaders:
    train_dataloader = DataLoader(train_img_folder, batch_size=32, shuffle=True)
    
    model = configuracion_modelo(models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1), 4)
    ...
    with open(r'Scripts\Rama1\EjericiosPrácticos\5.TodoJunto\CNN\PIMDPrueba2\Pesos\LossTrainPIMD2.json', 'w') as f:
        json.dump(error, f)
    ...
    if opc:
        ruta_guardado = r'Scripts\Rama1\EjericiosPrácticos\5.TodoJunto\CNN\PIMDPrueba2\Pesos\PIMD2.pth'
